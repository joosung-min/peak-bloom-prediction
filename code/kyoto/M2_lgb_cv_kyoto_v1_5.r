...
# v1: we try using Kyoto data only, without under-sampling
...
Rdata_name <- "./outputs/M21_lgb_RDada_kyoto1.RData"
grid_result_filename <- "./outputs/M22_lgb_grid_kyoto1.csv"
grid_best_filename <- "./outputs/M23_lgb_best_params_kyoto1.csv"
lgb_final_name <- "./outputs/M24_lgb_final_kyoto1.rds"

## Initial testing params
