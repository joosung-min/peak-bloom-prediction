...
def train_cherry_blossom(trial):
    ...
    mae = compute_mae(city = "Kyoto", test_set = test_set)
...
```{python}
cherry_complete_path = data_dir + "/B11_japan_complete.csv"
...
if os.path.isfile(cherry_complete_path):
    ...
    temp_path = data_dir + "/A11_japan_temperatures2.csv"
...
# save the best model
with open(model_dir + "/B11_lgb_kyoto.pkl", 'wb') as model:
    pickle.dump(best_model, model)

# save the study
with open(model_dir + "/B11_study_kyoto.pkl", 'wb') as st:
